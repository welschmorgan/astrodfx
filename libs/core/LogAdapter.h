...
namespace quasar {
	namespace core {
		...
		public:
			 ...
			 */
			virtual PropertyMap getFormatVars(const LogEntry &e) const noexcept = 0;
			 ...
			 */
			virtual String      format(const LogEntry &e) = 0;
		};

		using SharedLogEntryFormatter = std::shared_ptr<LogEntryFormatter>;


		class StandardLogEntryFormatter: public LogEntryFormatter {
		protected:
			String                      mFormat;

		public:
			StandardLogEntryFormatter(const String &formatStr = String());
			StandardLogEntryFormatter(const StandardLogEntryFormatter &rhs) = default;
			virtual ~StandardLogEntryFormatter() = default;

			StandardLogEntryFormatter    &operator=(const StandardLogEntryFormatter &rhs) = default;

			virtual PropertyMap         getFormatVars(const LogEntry &e) const noexcept override;
			virtual String              format(const LogEntry &e) override;
		};
		...
		public:
			LogAdapter(const String &name = String(), const SharedLogEntryFormatter &fmt = SharedLogEntryFormatter());
